...
# def validate(data):
#     is_sequence = isinstance(data, (list, tuple))#check if the data is list ot tuple
...
#     for index, dictionary in enumerate(data):#unpacking and check if the dictionary is dict
#         if not isinstance(dictionary, dict):
#             print(f'Invalid format: expected a dictionary at position {index}.')
#             is_invalid = True

#         if set(dictionary.keys())!=key_set:
#                 #transform the dictionary.keys to set type
